...
/**
 * Step3Report Component
 * Renders the overall performance report card at the end of the interview.
 * Uses clean Tailwind CSS layout with simple tables, charts, progress-bars and no heavy animations.
 * PDF generation has been completely removed.
 */
function Step3Report({ report }) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8 border-t border-gray-200'>
      ...
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          <button
            ...
            className='mt-1 p-3 rounded-full bg-white shadow-sm border border-gray-200 hover:bg-gray-50 transition'
          >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        {/* Right Charts and Table Section */}
